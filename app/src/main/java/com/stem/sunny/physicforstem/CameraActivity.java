        ...
        meter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(meterdone[0] == false) {
                    ...
                    final Toast[] temp = {Toast.makeText(CameraActivity.this, "Current Height: " + pxPerM, Toast.LENGTH_SHORT)};
                    temp[0].show();
                        ...
                        public boolean onTouch(View v, MotionEvent event) {
                            ...
                            switch (event.getAction() & MotionEvent.ACTION_MASK) {
                                ...
                                case MotionEvent.ACTION_UP:
                                    ...
                                    pxPerM = meterLine.getHeight();
                                    temp[0] = Toast.makeText(CameraActivity.this, "Current height: " + pxPerM, Toast.LENGTH_SHORT);
                                    temp[0].show();
                                    t.show();
                                    break;
